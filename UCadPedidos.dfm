object frmCadPedidos: TfrmCadPedidos
    ...
    object TabSheet3: TTabSheet
      ...
      object v: TGroupBox
        ...
        object DBGrid2: TDBGrid
          ...
          Height = 153
          Hint = 
            'Quando a linha estiver em "vermelho" significa que o Item j'#225' foi' +
            #13#10'                    adicionado em uma Nota Fiscal. '
          TabStop = False
          Color = clBlack
          DataSource = DM.DSQRItensCompra
          FixedColor = clNavy
  ...
  object DsSomatorias: TDataSource
    DataSet = Somatorias
    Left = 528
    Top = 520
  end
  object Somatorias: TADOQuery
    Active = True
    ...
    Left = 496
    Top = 520
    object SomatoriasTotalitens: TFloatField
      FieldName = 'Totalitens'
    end
    object SomatoriasTotalGeral: TBCDField
  ...
  object Pedido: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select * from cad_compra where pedidofechado = false and  dataen' +
        'trega between (date() - 180) and (date() + 190)'
      'order by empresa')
    Left = 632
    Top = 520
  ...
  object TotItensSemNf: TADOQuery
    Active = True
    Connection = DM.LigaBD
    CursorType = ctStatic
    DataSource = DM.DSQrPedido
    ...
    SQL.Strings = (
        ...
        'select sum(totalitens) as Totalitens from Itenscompra where Id_N' +
        'F = 0 and cod_compra = :cod_compra')
    Left = 400
    Top = 520
    object TotItensSemNfTotalitens: TFloatField
      FieldName = 'Totalitens'
    end
  end
  object DSTotItensSemNf: TDataSource
    DataSet = TotItensSemNf
    Left = 440
    Top = 520
  end
end
