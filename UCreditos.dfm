object FrmCreditos: TFrmCreditos
  ...
  object QrFiltro: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select * from Cad_Creditos where data between (date() - 30) and ' +
        '(date() + 190) order by data desc')
    Left = 352
    Top = 240
    object QrFiltroCodCredito: TAutoIncField
    ...
    object QrFiltroDinheiro: TBCDField
      FieldName = 'Dinheiro'
      DisplayFormat = '0.00'
      Precision = 19
    end
    object QrFiltroChequePre: TBCDField
      FieldName = 'ChequePre'
      DisplayFormat = '0.00'
      Precision = 19
    end
    object QrFiltroCartaoVisa: TBCDField
      FieldName = 'CartaoVisa'
      DisplayFormat = '0.00'
      Precision = 19
    end
    object QrFiltroCartaoCred: TBCDField
      FieldName = 'CartaoCred'
      DisplayFormat = '0.00'
      Precision = 19
    end
  end
  object DsQrFiltro: TDataSource
    DataSet = QrFiltro
    Left = 392
    Top = 240
  end
