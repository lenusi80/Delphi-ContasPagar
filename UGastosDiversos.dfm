object FrmGastosDiversos: TFrmGastosDiversos
  Left = 0
  Top = 0
  ...
  object GroupBox1: TGroupBox
    ...
    object DBEdit1: TDBEdit
      ...
      Ctl3D = False
      DataField = 'Data'
      DataSource = DM.DsQRDespDiversas
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlue
      Font.Height = -16
      Font.Name = 'Default'
    ...
    object CheckBox2: TCheckBox
      ...
      Width = 276
      Height = 17
      Caption = 'Visualizar somente lan'#231'amentos do dia'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -12
      Font.Name = 'Arial'
  ...
  object Soma: TADOQuery
    ...
    SQL.Strings = (
        ...
        ' select sum(valor) as Total from Cad_DespDiversas where data bet' +
        'ween (date() - 30) and (date() + 190)')
    Left = 272
    Top = 352
    object SomaTotal: TBCDField
      FieldName = 'Total'
      currency = True
      Precision = 19
    end
